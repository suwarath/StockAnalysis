...
def test_pre_process_data():
    """2. Test Downloaded data from yahoo finance which should not have any NA value in any columns"""
    
    test_ticker = 'AAPL'
    test_start = '2023-06-01'
    test_end = '2023-07-01'

    actual_output = process_data(test_ticker, test_start, test_end).isnull().any().sum()
